...
do
  ...
  OMP_NUM_THREADS=24 CUDA_VISIBLE_DEVICES=0 python scripts/plan_guided.py \
    ...
    --logbase logs \
    --diffusion_loadpath 'f:diffusion/flowmatching_H4_T4_S0' \
    --value_loadpath 'f:values/flowmatch_H4_T4_S0_d0.99' \
    --horizon 4 \
    --n_diffusion_steps 4 \
    --seed $seed \
  ...
  OMP_NUM_THREADS=24 CUDA_VISIBLE_DEVICES=1 python scripts/plan_guided.py \
    --dataset halfcheetah-medium-expert-v2 \
    --logbase logs \
    --diffusion_loadpath 'f:diffusion/flowmatching_H4_T8_S0' \
    --value_loadpath 'f:values/flowmatch_H4_T8_S0_d0.99' \
    --horizon 4 \
    --n_diffusion_steps 8 \
    --seed $seed \
