...
mkdir -p output
mkdir -p output/flowmatcher_plan_1,2
...
do
  ...
  OMP_NUM_THREADS=24 CUDA_VISIBLE_DEVICES=0 python scripts/plan_guided.py \
    ...
    --logbase logs \
    --diffusion_loadpath 'f:flowmatching/flowmatcher_H4_T1_S0' \
    --value_loadpath 'f:values/flowmatching_H4_T1_S0_d0.99' \
    --horizon 4 \
    --n_diffusion_steps 1 \
    --seed $seed \
    --discount 0.99 > output/flowmatcher_plan_1,2/output_0_seed_${seed}.log 2>&1 &
  ...
  OMP_NUM_THREADS=24 CUDA_VISIBLE_DEVICES=1 python scripts/plan_guided.py \
    --dataset halfcheetah-medium-expert-v2 \
    --logbase logs \
    --diffusion_loadpath 'f:flowmatching/flowmatcher_H4_T2_S0' \
    --value_loadpath 'f:values/flowmatching_H4_T2_S0_d0.99' \
    --horizon 4 \
    --n_diffusion_steps 2 \
    --seed $seed \
    --discount 0.99 > output/flowmatcher_plan_1,2/output_1_seed_${seed}.log 2>&1 &
  ...
  OMP_NUM_THREADS=24 CUDA_VISIBLE_DEVICES=2 python scripts/plan_guided.py \
    ...
    --n_diffusion_steps 1 \
    --seed $seed \
    --discount 0.99 > output/flowmatcher_plan_1,2/output_2_seed_${seed}.log 2>&1 &
  ...
  OMP_NUM_THREADS=24 CUDA_VISIBLE_DEVICES=3 python scripts/plan_guided.py \
    ...
    --n_diffusion_steps 2 \
    --seed $seed \
    --discount 0.99 > output/flowmatcher_plan_1,2/output_3_seed_${seed}.log 2>&1 &
